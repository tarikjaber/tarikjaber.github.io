...
let documentNameInput = document.getElementById('document-name-input') as HTMLInputElement;
let documentTitle = document.getElementById('document-title');
let languageSelector = document.getElementById('languages') as HTMLSelectElement
let codeLines = document.getElementById('line-nums');
let themeStylesheet = document.getElementById('theme-style') as HTMLAnchorElement;
let themeSelector = document.getElementById('themes') as HTMLSelectElement;
